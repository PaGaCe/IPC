...
function SeasonWrapped({
  ...
  const fmtResult = (f, teamName) => {
    if (!f) return "N/A";
    return `${f.home} ${f.homeGoals}-${f.awayGoals} ${f.away}`;
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {current.id === "outro" && <SlideOutro onClose={onClose} />}
      </div>
